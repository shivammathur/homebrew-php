class PhpAT81 < Formula
  ...
  url "https://github.com/php/php-src/archive/master.tar.gz?v=8.1.0&build_time=1607907331"
  version "8.1.0"
  sha256 "35e11d221e1b094d01b42754f79f339a241cdee256ec6eb4e76a30141a0a8115"
  license "PHP-3.01"

  bottle do
    root_url "https://dl.bintray.com/shivammathur/php"
    rebuild 78
    sha256 "fe5b7e863c84d072a392640c5d777a793f1b4c8e231630d0825ff42a4ffd7e7a" => :big_sur
    sha256 "96892762a36cf718d1a81d34bc3ea8bd4166f0fa9edc29b57dcac0f84a84a343" => :catalina
  end
